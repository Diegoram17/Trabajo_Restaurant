...
|---|---|---|---|---|
| 1 | Esqueleto de aplicación y esquema base | Backend Node+tRPC, SPA React con 4 rutas, PostgreSQL, migraciones, entidades de configuración sembradas, **TLS con CA propia del local y backend que no escucha en claro** (ADR-0033) | — | Generación y custodia de la CA |
...
| 5 | Identidad del mesero y sesión | `Persona`, PIN de 4 dígitos con **Argon2id y sal por credencial** (ADR-0036), **verificar PIN exige cookie de dispositivo** (ADR-0034), bloqueo por dispositivo con escalera y contador de respaldo por IP, sesión corta de estación | #3 | — |
